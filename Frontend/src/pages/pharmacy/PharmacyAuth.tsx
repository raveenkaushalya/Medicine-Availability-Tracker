...
interface PharmacyAuthProps {
  onLogin: () => void;
  onRegister?: (pharmacy: Omit<PendingPharmacy, 'id' | 'submittedDate' | 'status'>) => void;
}
...
export function PharmacyAuth({ onLogin, onRegister }: PharmacyAuthProps) {
  ...
  const slides = [
    {
      ...
      description: 'Connecting pharmacies across the country to ensure drug availability and better healthcare access. Join our network of trusted pharmaceutical partners.'
    },
    {
      title: 'Real-Time Inventory',
      subtitle: 'Medicine Tracking System',
      description: 'Track medicine availability in real-time across all connected pharmacies. Help patients find the medications they need, when they need them.'
    },
    {
      title: 'Grow Your Business',
      subtitle: 'Expand Your Reach',
      description: 'Connect with more patients and healthcare providers. Increase your pharmacy\'s visibility and become part of Sri Lanka\'s largest pharmacy network.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Your pharmacy registration has been submitted successfully. Our admin team will review your application and notify you via email once it's approved.
                </p>
                <motion.button
      ...
      {/* Main Content */}
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-3 pb-12 lg:pb-24" style={{ paddingTop: '90px' }}>
            ...
            >
              <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center justify-center">
                ...
                <div className="w-full lg:w-1/2 cursor-pointer group hidden lg:block">
                  <div className="relative w-full overflow-hidden shadow-2xl" style={{ borderRadius: '3rem', height: '560px' }}>
                    <img
                      src={capsulesImage}
                      alt="Pharmacy"
                          ...
                          >
                            {slides.map((slide, idx) => (
                              <div key={idx} className="flex-shrink-0 w-full">
                                <h5 className="text-2xl sm:text-3xl font-bold text-white mb-2">{slide.title}</h5>
                                <span className="block text-sm font-semibold text-lime-300 mb-4 tracking-wide uppercase">{slide.subtitle}</span>
                                <p className="text-white/90 leading-relaxed text-base sm:text-lg">{slide.description}</p>
                              </div>
                            ))}
                          </motion.div>
                        </div>
                        <div className="mt-6 flex gap-2">
                          {slides.map((_, idx) => (
                            <button
                              ...
                              className={`h-1.5 rounded-full transition-all duration-300 ${activeSlide === idx ? 'bg-lime-400 w-8' : 'bg-white/40 w-2 hover:bg-white/60'
                                }`}
                ...
                <div className="w-full lg:w-1/2 mx-auto" style={{ maxWidth: '490px' }}>
                  <div className="bg-white shadow-xl p-5 sm:p-7 border border-gray-100" style={{ borderRadius: '2rem' }}>
                    <div className="flex flex-col items-center mb-4">
                      ...
                      <h3 className="text-2xl font-bold text-gray-900 text-center mt-2">Pharmora Portal</h3>
                      <p className="text-gray-500 mt-2 text-center text-sm">Welcome back! Please sign in to continue.</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                      ...
                      <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="rememberMe" className="ml-2 text-sm text-gray-600 cursor-pointer select-none">Remember for 30 days</label>
                      </div>
              ...
              <form onSubmit={handleRegister} className="space-y-6">
                ...
                <div className="mb-8">
                  <div className="flex justify-between relative">
                    ...
                    <div className="absolute top-4 left-0 right-0 h-0.5 bg-gray-200 z-0" style={{ left: '16px', right: '16px' }}>
                      <motion.div
                        initial={false}
                        animate={{
                    ...
                    {[
                      ...
                      <div key={s.num} className="flex flex-col items-center relative z-10">
                        <motion.div
                          ...
                          className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 border-2 ${step >= s.num
                        ...
                        <span
                          className={`mt-2 text-sm ${step >= s.num ? 'text-indigo-900' : 'text-gray-500'
                            }`}
                        >
                          {s.label}
                        </span>
                ...
                {step === 1 && (
                  ...
                  >
                    <div className="text-center mb-4">
                      <h2 className="text-2xl text-gray-900">Business Information</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleInputChange('nmraLicense', e.target.value)}
                          className="bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 block w-full p-4 transition-all hover:bg-white"
                          required
                        />
                      </div>
                    ...
                    <div>
                      <label className="block text-gray-700 text-sm mb-2">
                        Address in Sri Lanka <span className="text-red-500">*</span>
                      </label>
                      <textarea
                ...
                {step === 2 && (
                  ...
                  >
                    <div className="text-center mb-4">
                      ...
                      <p className="text-gray-600">Who should we reach out to?</p>
                    </div>
                  ...
                  >
                    ...
                    <label className="flex items-start p-4 border-2 border-indigo-200 bg-white/30 backdrop-blur-sm rounded-xl cursor-pointer hover:border-indigo-400 transition-all">
                      ...
                      <span className="ml-3 text-gray-700 text-sm leading-relaxed">
                        I agree to the declaration above and confirm all information is accurate. <span className="text-red-500">*</span>
                      </span>
                    </label>
                  </motion.div>
                )}
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="flex-1 bg-indigo-900 text-white py-3 rounded-xl transition-all shadow-lg relative group overflow-hidden focus:ring-4 focus:ring-lime-300"
                  >
                    <span className="relative">{step === 3 ? 'Register' : 'Next'}</span>
                  </motion.button>
                </div>
              </form>
            </motion.div>
